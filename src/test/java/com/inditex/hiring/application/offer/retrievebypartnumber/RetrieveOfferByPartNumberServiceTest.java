...
import static com.inditex.hiring.OfferFixtures.ANY_ALL_OFFERS_FOR_INTERVALS;
...
class RetrieveOfferByPartNumberServiceTest {
    ...
    void should_retrieve_all_offers() {
        //given
        mock_find_all_offers_by_brand_id_and_part_number();
        //when
    ...
    private void mock_find_all_offers_by_brand_id_and_part_number() {
        Mockito.when(offerRepository.findByBrandIdPartNumber(ANY_BRAND_ID, ANY_PART_NUMBER))
                .thenReturn(ANY_ALL_OFFERS_FOR_INTERVALS);
    }
